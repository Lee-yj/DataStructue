...
import utils.RedBlackTree.RBTree;
...
//			Collections.sort(words);
			...
			System.out.println("Frequency of PREIDE:" + bstMap.get("pride"));
			...
			System.out.println("Frequency of PREIDE:" + rbTree.get("pride"));
			...
			System.out.println("Frequency of PREIDE:" + avlMap.get("pride"));
			...
			System.out.println("Frequency of PREIDE:" + hashTable.get("pride"));
			System.out.println("HashTable-统计词频:" + (endTime - startTime) / 1000000000.0);
		}
	}
}
